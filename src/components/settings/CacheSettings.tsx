          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable caching system</span>
                <span className="text-xs text-default-500">Enable overall caching functionality</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable query cache</span>
                <span className="text-xs text-default-500">Cache database queries for better performance</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable view cache</span>
                <span className="text-xs text-default-500">Cache rendered views and templates</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable route cache</span>
                <span className="text-xs text-default-500">Cache application routes</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable config cache</span>
                <span className="text-xs text-default-500">Cache configuration files</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable event cache</span>
                <span className="text-xs text-default-500">Cache event listeners and handlers</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable session cache</span>
                <span className="text-xs text-default-500">Cache user sessions</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable user cache</span>
                <span className="text-xs text-default-500">Cache user data and profiles</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable employee cache</span>
                <span className="text-xs text-default-500">Cache employee information</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable department cache</span>
                <span className="text-xs text-default-500">Cache department and organizational data</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable attendance cache</span>
                <span className="text-xs text-default-500">Cache attendance records and reports</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable leave cache</span>
                <span className="text-xs text-default-500">Cache leave requests and balances</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Enable payroll cache</span>
                <span className="text-xs text-default-500">Cache payroll calculations and reports</span>
              </div>
              <Switch
      ...
      <Card>
        ...
        <CardBody className="space-y-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Auto-clear cache on updates</span>
                <span className="text-xs text-default-500">Automatically clear cache when data is updated</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Clear cache on data updates</span>
                <span className="text-xs text-default-500">Clear relevant cache when data is modified</span>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3 bg-content1 rounded-lg">
              <div className="flex flex-col">
                <span className="text-sm font-medium text-foreground">Clear cache on data deletion</span>
                <span className="text-xs text-default-500">Clear relevant cache when data is deleted</span>
              </div>
              <Switch
