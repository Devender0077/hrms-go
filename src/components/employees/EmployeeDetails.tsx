    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-gray-50 rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <span className="text-gray-500 text-sm">Attendance Policy</span>
            <p className="font-medium">
      ...
      {/* Bank Information */}
      <div className="p-4 bg-gray-50 rounded-lg">
        <h4 className="text-lg font-semibold text-gray-900 mb-4">Bank Information</h4>
        <div className="grid grid-cols-2 gap-4">
          <div>
          ...
          <div>
            <span className="text-gray-500 text-sm">SWIFT Code</span>
            <p className="font-medium">{employee.bank_swift_code || 'N/A'}</p>
          </div>
          <div className="col-span-2">
            <span className="text-gray-500 text-sm">Bank Address</span>
